    ...
    def stream_gpt_response(self, text_widget, status_label, button):
        with self.lock:
            ...
            try:
                ...
                # Insert the "Answer:" label once at the start
                ...
                for chunk in stream:
                    ...
                    if delta:
                        ...
                        # Flush every 50ms or 20+ characters
...
class Application(tk.Tk):
    ...
    def submit_text_question(self):
        ...
        # Convert list content to flat string if needed
        ...
        # Insert the question in the response box
        self.response_box.config(state=tk.NORMAL)
        self.response_box.insert(tk.END, f"\n\nQuestion: {flat_content.strip()}\n")
        self.response_box.config(state=tk.DISABLED)
        self.response_box.see(tk.END)

        # Add message for GPT context
    ...
    def process_recording(self):
        try:
            ...
            # === Insert the transcribed question into the chat box just like typed input ===
            self.response_box.config(state=tk.NORMAL)
