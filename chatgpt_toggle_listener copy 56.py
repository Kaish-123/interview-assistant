...
if __name__ == "__main__":
    ...
    def setup_hotkey_listener():
        # Add at the top of setup_hotkey_listener or within it
        combo_focus = {keyboard.KeyCode(char='1'), keyboard.Key.down}
        current_keys = set()

        def on_activate_focus_input():
            print("🎯 Global hotkey 1 + ↓: Focus chat input + auto-send")
            app.focus_force()
            app.lift()
            ...
            app.send_input()  # This simulates pressing Enter
        ...
        def on_press(key):
            ...
            if key in combo_focus:
                current_keys.add(key)
                if combo_focus <= current_keys:
                    on_activate_focus_input()
        ...
        def on_activate_screenshot():
            ...
            try:
                ...
                # Get the list of displays/screens
                ...
                if not target_screen:
                    ...
                    print("❌ No monitor found under mouse")
                    return

                # Screenshot the entire monitor where mouse is present
                region = target_screen
