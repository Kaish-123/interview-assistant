...
# ⬇️ Call this inside `__main__` block or right after `app = Application()`:
...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.setup_ui()
        self.bind_all("<Command-v>", self.handle_paste)  # ⌘ + V paste
...
if __name__ == "__main__":
    ...
    app.mainloop()
    listener.join()  # keeps hotkey listener running after UI loop
